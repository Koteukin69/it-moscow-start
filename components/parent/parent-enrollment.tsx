  ...
  },
  {
    ...
    description: (
      <ul className="space-y-1 text-left text-sm text-muted-foreground">
        <li>после 9 класса: Сумма первичных баллов 2 экзаменов ОГЭ: русский язык и математика</li>
        <li>после 11 класса: Средний балл аттестата</li>
      </ul>
    ),
  },
  {
